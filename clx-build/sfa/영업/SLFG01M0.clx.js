	...
	var app = new cpr.core.App("sfa/영업/SLFG01M0", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			dataSet_1.parseData({
				...
				"rows": [
					{"column1": "00803", "column2": "전사", "column3": "4732187", "column4": "4608065", "column5": "97.3", "column6": "5187908", "column7": "4938102", "column8": "95.1", "column9": "4613968", "column10": "42955457", "column11": "93.0"},
					{"column1": "00803", "column2": "전사", "column3": "4732187", "column4": "4608065", "column5": "97.3", "column6": "5187908", "column7": "4938102", "column8": "95.1", "column9": "4613968", "column10": "42955457", "column11": "93.0"},
					{"column1": "00803", "column2": "전사", "column3": "4732187", "column4": "4608065", "column5": "97.3", "column6": "5187908", "column7": "4938102", "column8": "95.1", "column9": "4613968", "column10": "42955457", "column11": "93.0"},
					{"column1": "00803", "column2": "전사", "column3": "4732187", "column4": "4608065", "column5": "97.3", "column6": "5187908", "column7": "4938102", "column8": "95.1", "column9": "4613968", "column10": "42955457", "column11": "93.0"},
					{"column1": "00803", "column2": "전사", "column3": "4732187", "column4": "4608065", "column5": "97.3", "column6": "5187908", "column7": "4938102", "column8": "95.1", "column9": "4613968", "column10": "42955457", "column11": "93.0"},
			...
			(function(container){
				...
				(function(container){
									...
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_16.bind("value").toDataColumn("column3");
												return output_16;
											})();
									...
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_17.bind("value").toDataColumn("column4");
												return output_17;
											})();
											cell.controlConstraint = {};
										}
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_18.bind("value").toDataColumn("column5");
												return output_18;
											})();
											cell.controlConstraint = {};
										}
									...
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_20.bind("value").toDataColumn("column7");
												return output_20;
											})();
											cell.controlConstraint = {};
										}
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_21.bind("value").toDataColumn("column8");
												return output_21;
											})();
											cell.controlConstraint = {};
										}
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_22.bind("value").toDataColumn("column9");
												return output_22;
											})();
											cell.controlConstraint = {};
										}
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_23.bind("value").toDataColumn("column10");
												return output_23;
											})();
											cell.controlConstraint = {};
										}
									},
									{
										...
										"configurator": function(cell){
											...
											cell.control = (function(){
												...
												output_24.bind("value").toDataColumn("column11");
												return output_24;
											})();
											cell.controlConstraint = {};
										}
					...
					(function(container){
						...
						output_25.value = "- 단위 : 건수-건, 보험료-천원 / 더블클릭시 전사→채널→본부→지점→영업소→설계사별 순으로 조회됩니다.";
