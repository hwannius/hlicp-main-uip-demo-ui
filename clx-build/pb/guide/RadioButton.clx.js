/*
 * App URI: pb/guide/RadioButton
 * Source Location: pb/guide/RadioButton.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/RadioButton", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "라디오버튼";
					...
					(function(container){
						...
						radioButton_2.style.setClasses(["cl-focus"]);
						radioButton_2.style.icon.setClasses(["cl-focus"]);
				...
				(function(container){
					...
					formLayout_2.setColumns(["150px", "60px", "250px", "1fr"]);
					formLayout_2.setUseColumnShade(0, true);
					formLayout_2.setRows(["28px", "26px", "26px", "26px", "26px", "26px", "26px", "26px", "26px"]);
					...
					(function(container){
						...
						output_12.value = "아이템을 플로우 레이아웃의 형태로 배치하는 경우 \"-1\"의 값을 적용. 상황에 따라 \"0\"이상의 값을 설정할 수 있음";
						...
						output_20.value = "아이템의 텍스트 크기에 맞게 표시하기 위해 fixedWidth=\"false\"로 지정한다.";
						container.addChild(output_20, {
							"colIndex": 3,
							"rowIndex": 3
						});
						var output_21 = new cpr.controls.Output();
						output_21.value = "hideIcon";
						...
						output_24.value = "텍스트만 표시되는 라디오 버튼인 경우 해당 속성 사용";
						container.addChild(output_24, {
							"colIndex": 3,
							"rowIndex": 4
						});
						var output_25 = new cpr.controls.Output();
						output_25.value = "horizontalSpacing";
						...
						output_31.value = "\"top\" | \"right\" | \"bottom\" | \"left\"";
						...
						output_32.value = "아이콘이 좌측이 아닌 다른 방향으로 표시되는 경우 해당 속성을 변경";
						...
						output_36.value = "마우스 오버 시 인풋박스에 대한 힌트 제공 필요할 때 사용. 해당 속성을 작성하면 title 속성으로 적용됨";
			...
			(function(container){
				...
				(function(container){
					...
					formLayout_3.setColumns(["150px", "280px", "1fr"]);
					...
					(function(container){
						...
						radioButton_4.style.setClasses(["text-center"]);
						...
						(function(container){
							...
							(function(radioButton_5){
								radioButton_5.addItem(new cpr.controls.Item("USD", "usd"));
								radioButton_5.addItem(new cpr.controls.Item("KRW", "krw"));
							})(radioButton_5);
						...
						output_47.value = "속성 설정 : colCount=0, hideIcon=true, horizontalSpacing=0";
