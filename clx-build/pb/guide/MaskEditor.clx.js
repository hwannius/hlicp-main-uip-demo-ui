/*
 * App URI: pb/guide/MaskEditor
 * Source Location: pb/guide/MaskEditor.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/MaskEditor", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "마스크에디터";
					...
					(function(container){
						...
						maskEditor_2.style.setClasses(["cl-focus"]);
						...
						var maskEditor_3 = new cpr.controls.MaskEditor();
				...
				(function(container){
					...
					(function(container){
						...
						output_12.value = "다음 컨트롤로 포커스 이동할지에 대한 여부";
						...
						output_24.value = "데이터를 입력 받을 형식";
						container.addChild(output_24, {
							"colIndex": 3,
							"rowIndex": 4
						});
						var output_25 = new cpr.controls.Output();
						output_25.value = "showClearButton";
						...
						output_28.value = "값을 초기화하는 버튼을 사용하지 않음";
			...
			(function(container){
				...
				(function(container){
					...
					(function(container){
						...
						var maskEditor_4 = new cpr.controls.MaskEditor();
						...
						var maskEditor_5 = new cpr.controls.MaskEditor();
