/*
 * App URI: pb/guide/NumberEditor
 * Source Location: pb/guide/NumberEditor.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/NumberEditor", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "넘버에디터";
					...
					(function(container){
						...
						numberEditor_2.style.setClasses(["cl-focus"]);
				...
				(function(container){
					...
					(function(container){
						...
						output_24.value = "값을 초기화하는 버튼을 사용하지 않음";
						container.addChild(output_24, {
							"colIndex": 3,
							"rowIndex": 4
						});
						var output_25 = new cpr.controls.Output();
						output_25.value = "spinButton";
						...
						output_28.value = "넘버에디터 우측에 표시되는 스핀 버튼을 사용하지 않음";
