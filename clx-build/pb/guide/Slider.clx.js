/*
 * App URI: pb/guide/Slider
 * Source Location: pb/guide/Slider.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/Slider", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "슬라이더";
					...
					(function(container){
						var slider_1 = new cpr.controls.Slider();
						slider_1.value = "50";
						container.addChild(slider_1, {
							"width": "150px",
							"height": "10px"
						});
						var slider_2 = new cpr.controls.Slider();
				...
				(function(container){
					...
					(function(container){
						...
						output_8.value = "\"forward\" | \"backward\"";
						...
						output_21.value = "슬라이더 최솟값";
						container.addChild(output_21, {
							"colIndex": 3,
							"rowIndex": 4
						});
						var output_22 = new cpr.controls.Output();
						output_22.value = "orientation";
						...
						output_24.value = "\"horizontal\" | \"vertical\"";
						...
						output_29.value = "값 조정 모드 사용 여부 (범위 선택)";
