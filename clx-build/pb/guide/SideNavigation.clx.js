/*
 * App URI: pb/guide/SideNavigation
 * Source Location: pb/guide/SideNavigation.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/SideNavigation", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "사이드내비게이션";
					...
					(function(container){
						...
						sideNavigation_2.enabled = false;
						sideNavigation_2.indent = 5;
						sideNavigation_2.selectionHighlightType = "independent";
						(function(sideNavigation_2){
							sideNavigation_2.setItemSet(app.lookup("ds"), {
								"label": "label",
								"value": "value",
								"parentValue": "parent"
							});
				...
				(function(container){
					...
					formLayout_1.setColumns(["160px", "60px", "220px", "1fr"]);
					...
					(function(container){
						...
						output_13.value = "아이템 노드 깊이가 기본값이 아니므로 indent 값 변경";
						container.addChild(output_13, {
							"colIndex": 3,
							"rowIndex": 2
						});
						var output_14 = new cpr.controls.Output();
						output_14.value = "selectionHighlightType";
						...
						output_17.value = "아이템 선택 상태를 표시할 유형 설정. 관련된 아이템을 모두 선택 표시하거나 선택한 아이템만 선택 표시할 수 있는 속성.";
