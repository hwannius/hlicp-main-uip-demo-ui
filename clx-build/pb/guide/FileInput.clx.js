/*
 * App URI: pb/guide/FileInput
 * Source Location: pb/guide/FileInput.clx
 *
 * This file was generated by eXbuilder6 compiler, Don't edit manually.
 */
(function() {
	var app = new cpr.core.App("pb/guide/FileInput", { 
		...
		onCreate: function(/* cpr.core.AppInstance */ app, exports) {
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_2.title = "파일인풋";
					...
					(function(container){
						...
						fileInput_2.style.setClasses(["cl-focus"]);
				...
				(function(container){
					...
					(function(container){
						...
						output_12.value = "파일 열기 창에서 보여줄 파일 형식";
						...
						output_28.value = "업로드할 수 있는 파일의 최대 데이터 크기";
						container.addChild(output_28, {
							"colIndex": 3,
							"rowIndex": 5
						});
						var output_29 = new cpr.controls.Output();
						output_29.value = "limitFileSizeUnit";
						...
						output_44.value = "마우스 오버 시 인풋박스에 대한 힌트 제공 필요할 때 사용. 해당 속성을 작성하면 title 속성으로 적용됨";
			...
			(function(container){
				...
				(function(container){
					...
					userDefinedControl_4.title = "확장 파일인풋";
					...
					formLayout_3.setColumns(["82px", "1fr", "82px", "1fr", "1px", "1fr"]);
					...
					(function(container){
						...
						formLayout_4.setColumns(["1fr", "63px"]);
						...
						formLayout_5.setColumns(["1fr", "83px"]);
						formLayout_5.setRows(["1fr"]);
						group_11.setLayout(formLayout_5);
						(function(container){
							var fileInput_5 = new cpr.controls.FileInput();
							container.addChild(fileInput_5, {
								"colIndex": 0,
								"rowIndex": 0
							});
							var button_2 = new cpr.controls.Button();
							button_2.value = "파일다운로드";
